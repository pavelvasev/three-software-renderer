 ...
 * @author avgp / http://www.geekonaut.de
 * Sources adapted to:
 * - use Uint8ClampedArray instead of a canvas
 * - be a CommonJS module (browserify compatible)
 * - contain all necessary bits: Adapted Three.Projector and former Three.Math.nextPowerOfTwo
 */
...
module.exports = function (parameters) {
  ...
  this.render = function (scene, camera) {
    ...
    for (var e = 0, el = elements.length; e < el; e++) {
      ...
      } else if (element instanceof Projector.RenderableSprite) {
